  ...
  settings: {
    ...
    appearance: {
      ...
      pet: {
        ...
        digitalHudTitle: 'HUD 显示方式',
        digitalHudDesc: '使用标准悬浮 HUD，或在其中显示 Petdex 伙伴。',
        digitalHudStandard: '标准',
        digitalHudPet: '数字宠物',
        digitalHudShow: '显示会话',
        digitalHudHide: '隐藏会话',
        digitalHudClose: '关闭 HUD 和数字宠物',
        digitalHudRequired: '请启用 Petdex 宠物以使用数字宠物显示方式。',
        on: '开启',
        off: '关闭',
        chooseTitle: '选择宠物',
