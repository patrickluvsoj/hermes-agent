  ...
  settings: {
    ...
    appearance: {
      ...
      pet: {
        ...
        digitalHudTitle: 'عرض HUD',
        digitalHudDesc: 'استخدم HUD العائم القياسي أو اعرض رفيق Petdex بداخله.',
        digitalHudStandard: 'قياسي',
        digitalHudPet: 'حيوان رقمي',
        digitalHudShow: 'إظهار المحادثة',
        digitalHudHide: 'إخفاء المحادثة',
        digitalHudClose: 'إغلاق HUD والحيوان الرقمي',
        digitalHudRequired: 'فعّل حيوان Petdex لاستخدام عرض الحيوان الرقمي.',
