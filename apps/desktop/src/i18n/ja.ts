  ...
  settings: {
    ...
    appearance: {
      ...
      pet: {
        ...
        digitalHudTitle: 'HUD 表示',
        digitalHudDesc: '標準のフローティング HUD、または Petdex コンパニオンを内蔵した表示を使用します。',
        digitalHudStandard: '標準',
        digitalHudPet: 'デジタルペット',
        digitalHudShow: '会話を表示',
        digitalHudHide: '会話を非表示',
        digitalHudClose: 'HUD とデジタルペットを閉じる',
        digitalHudRequired: 'デジタルペット表示を使用するには Petdex ペットを有効にしてください。',
        on: 'オン',
        off: 'オフ',
        chooseTitle: 'ペットを選ぶ',
